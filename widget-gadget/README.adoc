...
image::https://github.com/jboss-fuse/camel-spring-boot-examples/blob/camel-spring-boot-examples-4.0.0-RC2-branch/widget-gadget/img/artemis-console.png[link="https://github.com/jboss-fuse/camel-spring-boot-examples/blob/camel-spring-boot-examples-4.0.0-RC2-branch/widget-gadget/img/artemis-console.png"]
